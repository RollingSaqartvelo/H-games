export const ASSET_PATHS = {
  ...
  bg: {
    ...
    panels: [
      '/assets/bg/panel4_1.jpg',
      '/assets/bg/panel4_2.jpg',
      '/assets/bg/panel4_3.jpg',
      '/assets/bg/panel4_4.jpg',
      '/assets/bg/panel4_5.jpg',
      '/assets/bg/panel4_6.jpg',
      '/assets/bg/panel4_7.jpg',
      '/assets/bg/panel4_8.jpg',
    ] as readonly string[],
  },
